        ...
        <footer className="flex flex-col lg:flex-row gap-5 items-center justify-between container mx-auto bg-base-200 text-base-content border-base-300 border-t px-10 py-4">
          ...
          <nav className="md:place-self-center md:justify-self-end">
            <div className="grid grid-flow-col gap-2 ">
              <div>
                <Image src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508246/Badge_4_xtg1jo.png" width={50} height={50} alt="" />
              </div>
              <div>
                <Image src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508311/Badge_epq0c4.png" width={50} height={50} alt="" />
              </div>
              <div>
                <Image src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508335/Badge_1_he4sfd.png" width={50} height={50} alt="" />
              </div>
              <div>
                <Image src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508363/Badge_2_xgkizb.png" width={50} height={50} alt="" />
              </div>
              <div>
                <Image src="https://res.cloudinary.com/dqescabbl/image/upload/v1726508381/Badge_3_kv0fgp.png" width={50} height={50} alt="" />
              </div>
            </div>
          </nav>
        </footer>
