            ...
            <div className="lg:w-2/5">
                <Link href={"/register"}>
                    <div className="text-center my-5">
                        <button className='btn bg-black text-white px-12 hover:bg-white hover:text-black text-lg'><IoMdLogIn />Create Account</button>
                    </div>
                </Link>
                ...
                <div className=" w-11/12 mx-auto  lg:mt-20 ">
                    ...
                    <form action=""  className=''>
                        ...
                        <div className="">
                            <button className='bg-black text-white btn mt-5'>Login</button>
